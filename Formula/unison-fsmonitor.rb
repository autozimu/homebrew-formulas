...
class UnisonFsmonitor < Formula
  ...
  if OS.linux?
    ...
    if Hardware::CPU.intel?
      url "https://github.com/autozimu/unison-fsmonitor/releases/download/v0.3.3/unison-fsmonitor-macos-amd64.tar.gz"
    elsif Hardware::CPU.arm?
      url "https://github.com/autozimu/unison-fsmonitor/releases/download/v0.3.3/unison-fsmonitor-macos-aarch64.tar.gz"
    else
